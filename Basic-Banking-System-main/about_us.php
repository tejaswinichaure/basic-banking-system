...
<head>
    ...
    <title><b>About us - Sparks Bank</b></title>
...
<body style="background-color:#212529;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="spk.png" alt=""
                    style="height: 80px; margin-left:15px; margin-top:10px;"></a>
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="spk.png" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Tejaswini Chaure</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> MIT ACSC ALANDI, Pune</b></p>
    </center>
